...
public class CorpBindConfirmRes extends BankProxyRelayResponseMsg {
    ...
    public CorpBindConfirmRes(int result, String resInfo,String bankResult, String bankResInfo) {
