...
public class CorpInfo implements Serializable {
    ...
    // 企业注册状态：1：注册未授权2：注册且已授权（具体授权应用在企业授权表记录）
    public static int CORP_STATUS_UNAUTHED = 1;
    public static int CORP_STATUS_AUTHED = 2;
	...
	public String getSrcMchId() {
		return srcMchId;
	}
	public void setSrcMchId(String srcMchId) {
		this.srcMchId = srcMchId;
	}
