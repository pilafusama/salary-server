...
public interface WxHttpClient {
	...
	public String get_admin_list(@PathVariable("suiteAccessToken") String suiteAccessToken, @RequestBody String getAdminListReq);
	...
	@RequestMapping(method = RequestMethod.POST, value = "/service/get_register_code?provider_access_token={provider_access_token}", consumes = "application/json")
	public String getRegisterCode(@PathVariable("provider_access_token") String providerAccessToken, @RequestBody String reqData);
